...
struct OnlineTestingList: View {
    ...
    var body: some View {
        ...
        List {
            ...
            ForEach(onlineSchedulingTestingLocations.testingTestingLocations?.features ?? [], id: \.self) { testing in
...
struct OnlineTestingList_Previews: PreviewProvider {
