...
struct PedsTestingLocationList: View {
    @ObservedObject var pedsTestingLocations = PedsTestingLocations()
    var body: some View {
        NavigationView {
        List {
       
            ForEach(pedsTestingLocations.testingTestingLocations?.features ?? [], id: \.self) { testing in
...
struct PedsTestingLocationList_Previews: PreviewProvider {
