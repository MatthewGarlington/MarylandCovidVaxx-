...
struct NoCostTestingList: View {
    ...
    var body: some View {
        ...
        List {
            ...
            ForEach(costFreeTestingLocations.testingTestingLocations?.features ?? [], id: \.self) { testing in
...
struct NoCostTestingList_Previews: PreviewProvider {
