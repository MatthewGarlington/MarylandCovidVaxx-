//
//  HospitalVaccineDetailView.swift
//  CovidVaccMD
//
...
struct HospitalVaccineDetailView: View {
...
struct HospitalVaccineDetailView_Previews: PreviewProvider {
    static var previews: some View {
        HospitalVaccineDetailView()
    }
}
