...
struct SingleShotDoseList: View {
    @ObservedObject var dataController = HistoricalVaccineViewModel()
    ...
    var body: some View {
        ...
        VStack {
            ...
            ZStack {
                ...
                List {
                        VStack {
                        ForEach(dataController.recentMDVaccineTotals?.features?.reversed() ?? [], id: \.self) { vaccine in
                                ...
                                VStack {
                                    ...
                                    VStack(alignment: .leading, spacing: 12) {
                                        ...
                                        HStack {
                                            ...
                                            Text("Total Single Shot Dose:")
                                                .font(.system(size: 20, weight: .semibold))


                                            VStack(alignment: .leading) {
                                                Text("\(vaccine.attributes?.SingleDoseCumulative ?? 0)")
                                                        .font(.system(size: 20, weight: .semibold))
...
struct SingleShotDoseList_Previews: PreviewProvider {
