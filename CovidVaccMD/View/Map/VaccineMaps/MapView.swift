...
struct RetailMapViewMaryland_Previews: PreviewProvider {
    static var previews: some View {
        RetailMapViewMaryland(annotations: .constant(MKPointAnnotation.exampleArray), pinsRetailArray: .constant(MKPointAnnotation.exampleArray), selectedPlace: .constant(MKPointAnnotation.example), showingPlaceDetails: .constant(true))
    }
}
...
struct MassMapViewMaryland_Previews: PreviewProvider {
    static var previews: some View {
        MassMapViewMaryland(annotations: .constant(MKPointAnnotation.exampleArray), pinsMassArray: .constant(MKPointAnnotation.exampleArray), selectedPlace: .constant(MKPointAnnotation.example), showingPlaceDetails: .constant(true))
    }
}
