...
struct MassVaccineList: View {
    ...
    var body: some View {
        ...
        List {
            ...
            ForEach(massVaccinationsitesViewModel.vaccineLocationsMD?.features ?? [], id: \.self) { vaccine in
...
struct MassVaccineList_Previews: PreviewProvider {
